...
This guide acts as a repository for getting started with Oracle Integration written by [Alex MacDonald](intro.alexmacdonald.solutions). You will find relevant resources for using it with a wide variety of use cases.
